...
class Pipe:
    ...
    def __init__(self, x, height, bird):
        self.x = x
        self.height = height
        self.top = 0
        self.bot = 0
        ...
        self.bird_height = bird.img.get_height()
        self.checkpoint = False
        self.set_height()

    def set_height(self):
        self.top = self.height - self.TOP_PIPE.get_height()
        self.bot = self.height + self.bird_height
...
def single_main():
    ...
    bird = FlappyBird(300, 350)
    pipes = [Pipe(WINDOW_H - 100, 350, bird)]
    ...
    while running:
        ...
        if add_pipe:
            score += 1
            if score == 9:
                pipes.append(Pipe(600, 351, bird))
            else:
                pipes.append(Pipe(600, 350, bird))
